...
public final class ModFluidStorages {
        ...
        private static Storage<FluidVariant> stackTank(ItemStack stack, long capacity) {
                return new SingleVariantStorage<>() {
                        ...
                        protected void onFinalCommit() {
                                ...
                                if (amount <= 0 || variant.isBlank()) {
                                        ...
                                        content = new ModDataComponents.FluidContent(
                                                        net.minecraft.registry.Registries.FLUID
                                                                        .getId(variant.getFluid()),
                                                        amount);
                                }
                        ...
                        @SuppressWarnings("null")
                        @Override
                        public long insert(@SuppressWarnings("null") FluidVariant insertedVariant,
                                        long maxAmount,
...

                        {
                                ...
                                if (c.isEmpty()) {
                                        ...
                                        variant = FluidVariant
                                                        .of(net.minecraft.registry.Registries.FLUID
                                                                        .get(c.fluidId()));
        ...
        public static void init() {
                ...
                FluidStorage.ITEM.registerForItems((stack, ctx) -> stackTank(stack,
