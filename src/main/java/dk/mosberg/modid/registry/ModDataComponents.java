...
public final class ModDataComponents {
                ...
                public static final Codec<FluidContent> CODEC =
                                RecordCodecBuilder.create(instance -> instance.group(
                                                Identifier.CODEC.fieldOf("fluid")
                                                                .forGetter(FluidContent::fluidId),
                                                Codec.LONG.fieldOf("amount")
                                                                .forGetter(FluidContent::amount))
                                                .apply(instance, FluidContent::new));

                @SuppressWarnings("null")
                public static final PacketCodec<RegistryByteBuf, FluidContent> PACKET_CODEC =
                                PacketCodec.tuple(Identifier.PACKET_CODEC, FluidContent::fluidId,
                                                PacketCodecs.LONG, FluidContent::amount,
                                                FluidContent::new);
        ...
        public static final ComponentType<FluidContent> FLUID_CONTENT = Registry.register(
                        ...
                        Identifier.of(ModId.MOD_ID, "fluid_content"),
